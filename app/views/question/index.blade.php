  ...
  <div class="col-sm-6 col-sm-offset-1">
   ...
   <div class='col-sm-5'>
       <div class="row" id='subquestions'>
           ...
           <div class='form-group'>
           <div class='col-sm-8 col-sm-offset-4'>{{ Form::select('subtype',array('one'=>"Only Single Answer Allowed",'many'=>"Allow More Than One Answer"),'',array('class'=>'form-control','required'=>'requiered','id'=>'subtype')) }} 
           </div></div>
           <ul>
           ...
           <div class='form-group'>
                ...
                <div class='col-sm-8'>{{ Form::textarea('answer','',array('class'=>'form-control','placeholder'=>'Multiple choice Answer', 'rows'=>'4')) }} </div>
            </div>
